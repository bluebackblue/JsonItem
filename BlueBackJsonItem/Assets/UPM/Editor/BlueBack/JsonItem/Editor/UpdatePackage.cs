	...
	*/
	public static class UpdatePackage
	{
		...
		*/
		...
		/** MenuItem_BlueBack_JsonItem_UpdatePackage
		*/
		#if(!DEF_USER_BLUEBACK_JSONITEM)
		[UnityEditor.MenuItem("BlueBack/JsonItem/UpdatePackage " + Version.packageversion)]
		#endif
		public static void MenuItem_BlueBack_JsonItem_UpdatePackage()
		{
			...
			if(t_version == null){
				...
				UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmJsonItem.git?path=BlueBackJsonItem/Assets/UPM");
			}else{
				UnityEditor.PackageManager.Client.Add("https://github.com/bluebackblue/UpmJsonItem.git?path=BlueBackJsonItem/Assets/UPM#" + t_version);
			}
		}
		...
		*/
		...
		{
			string t_url = "https://api.github.com/repos/bluebackblue/UpmJsonItem/releases/latest";
